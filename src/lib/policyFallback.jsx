...
// Fallback hardcoded sections — used only if the Policy entity is empty or query fails.
// This ensures the policies page never breaks even if the DB is unavailable.
export const FALLBACK_SECTIONS = [
  {
    id: 'privacy',
    title: 'Política de Privacidad',
    last_updated: '2 de mayo de 2026',
    content: (
