  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 z-50 bg-card/80 backdrop-blur-lg flex items-center justify-between px-4 safe-area-top">
        <button onClick={() => navigate(-1)} className="w-11 h-11 bg-secondary rounded-full flex items-center justify-center">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => navigate(createPageUrl('Cart'))} className="w-11 h-11 bg-secondary rounded-full flex items-center justify-center relative">
