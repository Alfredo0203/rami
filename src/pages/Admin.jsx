...
import { ArrowLeft, Plus, Package, ShoppingBag, DollarSign, TrendingUp, Edit2, Trash2, Loader2, Eye, EyeOff, Users, Settings, MessageSquare, LayoutGrid, BarChart3, Ticket, Search, AlertTriangle, History, Store, ChevronDown, ChevronUp, SlidersHorizontal, X, RotateCcw, FileText } from 'lucide-react';
        ...
        <Tabs defaultValue="products" className="flex flex-col flex-1 min-h-0">
          <div className="px-4 sticky top-0 z-40 bg-background overflow-x-auto">
            <TabsList className="w-full justify-start bg-transparent">
              ...
              <TabsTrigger value="refunds" className="px-2"><RotateCcw className="w-4 h-4" /></TabsTrigger>
              <TabsTrigger value="policies" className="px-2"><FileText className="w-4 h-4" /></TabsTrigger>
