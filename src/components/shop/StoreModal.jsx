                  ...
                  <div key={review.id} className="bg-card rounded-lg p-3 border border-border/50">
                    ...
                    {review.title && (
                      <button
                        ...
                        className="text-xs font-medium text-foreground mb-1 hover:text-primary transition-colors text-left w-full"
                      >
                        {review.title}
                      </button>
                    )}
                    <p className="text-xs text-muted-foreground line-clamp-2 mb-2">{review.body}</p>
